...
**Trade-off**: 103MB WAL file (managed via periodic checkpointing)
...
**Step 4: Document Agent** (docs/reference/agent-catalog.md):
```markdown
## My Agent
...
- Current: General-purpose agents (54 types)
