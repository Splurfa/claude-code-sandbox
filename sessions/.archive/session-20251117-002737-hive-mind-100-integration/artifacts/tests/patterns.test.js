...
const PatternMatcher = require('../code/patterns/pattern-matcher');
const PatternExtractor = require('../code/patterns/pattern-extractor');
const PatternApplicator = require('../code/patterns/pattern-applicator');
const { PatternMCP } = require('../code/patterns/pattern-mcp');
const path = require('path');
const fs = require('fs').promises;

// Test database path
const TEST_DB_PATH = '.swarm/memory.db';
...
describe('Vector Math Utilities', () => {
  const { cosineDistance, cosineSimilarity, euclideanDistance, normalize, dotProduct, magnitude } = require('../code/patterns/utils/vector-math');
