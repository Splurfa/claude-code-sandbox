...
| S3 | `CLAUDE.md` (workspace root). `/Users/splurfa/common-thread-sandbox/CLAUDE.md` | Workspace configuration | Provides MCP tool usage patterns, agent execution flow, coordination patterns, and file organization rules. Critical for understanding Claude-Flow's execution model and integration surface. | High |
| S4 | `docs/guides/concepts/hive-mind-system.md`. `/Users/splurfa/common-thread-sandbox/docs/guides/concepts/hive-mind-system.md` | Architecture reference | Supplies hive-mind architecture, queen-worker patterns, consensus mechanisms, and performance metrics. Used for Phase 2 architecture analysis and Phase 3 swarm coordination impact. | High |
