...
#
# Usage:
#   bash .claude/scripts/batch-closeout.sh [OPTIONS] [SESSION_IDS...]
#
# Options:
...
#
# Examples:
#   bash .claude/scripts/batch-closeout.sh --dry-run
#   bash .claude/scripts/batch-closeout.sh session-20251121-120000-issue-tracking-restructure
#   bash .claude/scripts/batch-closeout.sh --all --dry-run
#   bash .claude/scripts/batch-closeout.sh session-1 session-2 --verbose
#
